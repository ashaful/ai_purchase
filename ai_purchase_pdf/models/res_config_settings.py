...
class ResConfigSettings(models.TransientModel):
    ...
    ai_purchase_processing_mode = fields.Selection(
        [
        ...
        default='local_test',
        config_parameter='ai_purchase_pdf.processing_mode',
        required=True,
        help='No API Test Mode extracts embedded PDF text locally and uses rule-based parsing. OpenAI API mode uses AI for arbitrary PDF layouts.',
    )
